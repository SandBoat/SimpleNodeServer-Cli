...
let actionMap = {
    init: {
        ...
        usages: ['sns-cli init projectName']
    },
    config: {
        alias: 'cfg',
        description: 'config .sns-clirc',
        usages: ['sns-cli config set <k> <v>', 'sns-cli config get <k>', 'sns-cli config remove <k>']
...
// sns-cli -V   VERSION 为 package.json 中的版本号
